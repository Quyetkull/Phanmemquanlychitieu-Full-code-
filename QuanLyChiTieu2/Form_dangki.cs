...
namespace QuanLyChiTieu2
{
    public partial class Form_dangki : Form
    {
        ...
        string chuoiketnoi = @"Data Source=DESKTOP-MQ3E0HG\SQLEXPRESS;Initial Catalog=QLCT;Integrated Security=True";
        string sql;
        ...
        {
            ketnoi.Open();
            sql = @" Select UserName, PassWord FROM Tk";
        ...
        private void bt_dangki_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (nguoidung.Ktramatkhau() == true)
                {
                    ...
                    ketnoi.Open();
                    sql = @"insert into Tk(UserName , PassWord) values ('" + txt_taikhoan.Text + "', '" + txt_matkhau.Text + "') ";
                    thuchien = new SqlCommand(sql, ketnoi);
                ...
                {
                    MessageBox.Show("Mật khẩu phải bao gồm ít nhất 6 kí tự và phải có số");
                }
            }           
        }
